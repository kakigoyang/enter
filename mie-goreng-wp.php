...
$user = 'support'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = '3x3H86Xi%tq8INkxyW@3hGAL'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'support@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
